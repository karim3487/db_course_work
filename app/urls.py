...
urlpatterns = [
    ...
    path(
        "insurance-companies/",
        views.InsuranceCompanyListView.as_view(),
        name="ins_companies",
    ),
    path(
    ...
    path(
        ...
        views.export_ins_companies,
        name="export_ins_companies",
    ),
    # appointment
    ...
    path(
        "appointments/create", views.AppointmentCreateView.as_view(), name="create_app"
    ),
    path(
        "appointments/<pk>/update",
    ...
    path(
        "payments/<pk>/update", views.PaymentUpdateView.as_view(), name="update_payment"
    ),
    path(
        "payments/<pk>/delete", views.PaymentDeleteView.as_view(), name="delete_payment"
    ),
    ...
    path(
        "bill-payments/export/", views.export_bill_payments, name="export_bill_payments"
    ),
]
